...
Input Files:  students.txt & classHours.txt
Output File: data file will be user created
...
Execute in Visual Studio 2019 (ISO C++20 Standard (/std:c++20)):  
                        "Structures, arrays of structures, functions, header files, program logging.cpp"
                                ...
                                When program asks for first file name, enter:  students.txt
                                When program asks for second file name, enter:  classHours.txt
                                When program asks for third file name, enter:  name of output file
